...
There's a [prototype](https://github.com/greatscottgadgets/facedancer/pull/160) of a Facedancer backend based on Raw Gadget (based on [older prototype version](https://github.com/xairy/Facedancer/tree/rawgadget)).
